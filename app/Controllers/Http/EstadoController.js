...
class EstadoController {
  ...
  async show ({ params, request, response, view }) {
    const estado = await Estados.findBy('id', params.id)
    const estadomunicipio = await estado.municipio().fetch()
    return response.send({estadomunicipio})
  }
